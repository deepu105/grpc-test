...
public class AgathaApp {

    private static final Logger log = LoggerFactory.getLogger(AgathaApp.class);

    private final Environment env;

    public AgathaApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AgathaApp.class);
